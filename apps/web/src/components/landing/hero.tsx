...
export function Hero() {
  return (
    <section className="flex w-full flex-col-reverse items-center justify-between gap-8  md:flex-row md:gap-10">
      <motion.div
      ...
      >
        ...
        <div className="mb-2 flex w-full flex-col gap-3 font-medium sm:flex-row sm:gap-4">
          <motion.div className="rounded-xl" whileHover={{ scale: 1.05, boxShadow: '0 0 20px rgba(255,255,255,0.5)' }}>
            <Link
              href="/register"
              className="flex w-full rounded-xl items-center justify-center gap-2 bg-gradient-to-r from-primary-orange to-secondary-purple px-6 py-3 text-sm text-white transition will-change-transform hover:brightness-110 sm:w-auto sm:justify-start sm:px-8 sm:py-2 sm:text-base"
            >
          ...
          <motion.div className="rounded-xl" whileHover={{ scale: 1.05, boxShadow: '0 0 50px rgba(255,255,255,0.5)' }}>
            <Link
              href="/login"
